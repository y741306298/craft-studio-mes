package com.piliofpala.craftstudio.pangolin.infra.gatherplatform.imps.wdt.client;
import com.piliofpala.craftstudio.pangolin.infra.gatherplatform.imps.wdt.utils.WebUtils;
...
public class WdtClient {
    ...
    public String execute(String relativeUrl, Map<String, String> params) throws IOException {
        ...
        System.out.println(this.baseUrl + relativeUrl);
