...
class ImageToImageSearchServiceImpTest {
    ...
    void deletesSpecifiedDocumentFromDashVector() throws Exception {
        String apiKey = setting("dashvector.test.api-key", "DASHVECTOR_TEST_API_KEY");
        String endpoint = setting("dashvector.test.endpoint", "DASHVECTOR_TEST_ENDPOINT");
        String collectionName = setting("dashvector.test.collection", "DASHVECTOR_TEST_COLLECTION");
        String docId = setting("dashvector.test.doc-id", "DASHVECTOR_TEST_DOC_ID");
