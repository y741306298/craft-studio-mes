 ...
 */
@Service
public class RectBasicLayoutConfirmService implements TypesettingLayoutModeConfirmService {
    ...
    public TypesettingLayoutMode supportMode() {
        return TypesettingLayoutMode.RECT_TYPESETTING_BASIC;
    }
    ...
    public LayoutConfirmResult confirm(TypesettingInfo typesettingInfo) {
        ...
        result.setMessage("基础矩形排版确认完成，已保存数据");
        return result;
    }
}
