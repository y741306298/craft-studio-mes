package com.mes.interfaces.api.platform.manufacturerSide.materialLayoutSpec;
 ...
 */
@RestController
@RequestMapping("/api/manufacturerSide/materialLayoutSpec")
public class ManufacturerSideMaterialLayoutSpecController {
