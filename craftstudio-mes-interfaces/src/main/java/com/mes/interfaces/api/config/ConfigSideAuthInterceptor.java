...
@Component
public class ConfigSideAuthInterceptor implements HandlerInterceptor {

    private static final String BEARER_PREFIX = "Bearer ";

    private final AppConfigLoginService appConfigLoginService;

    public ConfigSideAuthInterceptor(AppConfigLoginService appConfigLoginService) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            appConfigLoginService.getConfigUserIdByToken(token);
