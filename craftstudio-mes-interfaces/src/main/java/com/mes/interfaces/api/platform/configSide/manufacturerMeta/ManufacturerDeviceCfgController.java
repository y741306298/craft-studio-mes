...
public class ManufacturerDeviceCfgController {
    ...
    public PagedApiResponse<DeviceCfgSummary> listDeviceCfgs(
        ...
        PagedResult<ManufacturerDeviceCfg> result = appDeviceCfgService.findDeviceCfgsByManufacturerId(manufacturerMetaId, request.getDeviceName(), request.getDeviceCode(), query);
